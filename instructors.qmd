...
:::
::: {.g-col-10}
Abdul Ghafoor is an Application Security Specialist with over a decade of experience in secure application development and vulnerability assessment. He holds a Ph.D. in 
...
::: {.grid}
::: {.g-col-2}
![](img/lars.jpg){width=80}
:::
::: {.g-col-10}
Lars works in research support, specializing in personal sensitive data and HPC, while also providing expertise in areas such as software architecture, quality control, 
theoretical chemistry, inorganic biochemistry, and related fields.
His career began as a software developer, later he studied biology and completed a PhD in theoretical inorganic physical chemistry, combining theoretical and experimental chemistry. 
He later worked in quality control at a pharmaceutical company, contributing to statistical sample analysis, requirements documentation, and spectroscopy and chromatography. 
Subsequently, Lars moved into research support, working as an Application Expert for an HPC cluster in Sweden and as a domain specialist in sensitive research data.
:::
:::
